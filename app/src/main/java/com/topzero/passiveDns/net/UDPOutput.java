...
package com.topzero.passiveDns.net;

import android.net.VpnService;
import android.util.Log;

import com.topzero.passiveDns.model.ByteBufferPool;
import com.topzero.passiveDns.model.LRUCache;
...
public class UDPOutput implements Runnable {
    private static final String TAG = UDPOutput.class.getSimpleName();  //设置类简称(UDPOutput)
